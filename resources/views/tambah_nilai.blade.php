        ...
        <form action="/" method="POST">
            ...
            <div class="input mb-3">
                ...
                <input type="text" name="nama" class="form-control" placeholder="Nama Peserta"
                    aria-label="Nama Peserta" aria-describedby="basic-addon1" disabled>
            </div>

            <div class="input mb-3">
                <label class="input-text" id="basic-addon1">Nilai</label>
                <input type="number" name="" class="form-control" placeholder="Nilai"
                    aria-label="Nilai" aria-describedby="basic-addon1" >
            </div>

            <div class="input mb-3">
                <label class="input-text" id="basic-addon1">Author</label>
                <input type="text" name="" class="form-control" placeholder="Author"
