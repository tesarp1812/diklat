...
<div class="px-4 py-5 my-5 text-center">
    ...
    <div class="col-lg-6 mx-auto">
      ...
      <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
        <a href="https://docs.google.com/forms/d/e/1FAIpQLSd7mbhV9891WGhlYtflthSOptLGMqLAYIePlMIqL_0_24gUpw/viewform" target="_blank" class="btn btn-primary btn-lg px-4 gap-3">Daftar Sekarang</a> 
        <div class="dropdown">
